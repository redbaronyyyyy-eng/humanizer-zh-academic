...
activation: |
  触发关键词：降低AI率、人工润色、降低AIGC、humanize、去AI味、
  学术写作润色、论文降重、AIGC检测、AI痕迹消除
allowed-tools:
  - Read
  - Write
  - Edit
  ...
  - Glob
metadata:
  trigger: 降低中文学术写作AIGC检测率
  source: |
    基于Wikipedia Signs of AI writing、真实论文对比实验、
    de-AI-writing skill (OUBIGFA)、humanizer-zh (op7418)
---
